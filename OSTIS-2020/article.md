# Принципы повышения эффективности процессов разработки и использования стандартов в рамках концепции Industry 4.0
...
На рис <> приведена иллюстрация отображения информации в виде мнемосхемы ЧМИ (из проекта АСУТП):

![Пример HMI из SCADA](figures/pic_SCADA_HMI.png)

На рис <> приведена web-страница, на которой отображена та же информация в виде PFC-схемы (из базы знаний):
