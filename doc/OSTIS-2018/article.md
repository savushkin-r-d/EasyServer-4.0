# ПРОЕКТИРОВАНИЕ ПРЕДПРИЯТИЯ РЕЦЕПТУРНОГО ПРОИЗВОДСТВА В КОНТЕКСТЕ НАПРАВЛЕНИЯ INDUSTRY 4.0

**Аннотация.** В данной работе рассматривается усовершенствованный подход к онтологическому проектированию предприятий рецептурного производства, использующий принципы, разработанные в рамках направления Industry 4.0.
...
## 1. Обзор и анализ
Индустрия 4.0, цели этого направления, актуальность
...
Разрабатываемая система должна обеспечивать комплексную автоматизацию процесса производства творога “Хуторок” от дойки коровы до поступления готовой продукции в магазин. В этом процессе можно выделить три основные стадии:
От дойки коровы до поступления молока на завод.
...
Рассмотрим конкретную задачу укладки готовой продукции, производимой на фасовочном автомате A3FLEX, на паллеты (рисунок 1). Данный автомат может выпускать несколько видов готовой продукции: несколько видов молока и различные соки. Каждый из продуктов имеет свои параметры при укладке на паллеты. При осуществлении паллетизации робот должен определить продукт, способ и количество  захватываемых продуктов за один раз, а также размещение группы продуктов на поддоне с учетом раскладки.
