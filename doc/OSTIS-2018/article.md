...
### 3.1 Модель логистических процессов на примере производства творога “Хуторок”
...
### 3.2 Модель языков описания ячейки производства творога “Хуторок”
...
### 3.3 Модель ячейки производства творога “Хуторок”

#### Мастер рецепт (*master recipe*)
Схема для мастер-рецепта приготовления творога Хуторок:

![Изображение мастер-рецепта](article-images/master_recipe.svg)

#### Рецептурная процедура (*recipe procedure*)

Схема рецептурной процедуры для приготовления творожной массы:

![Изображение рецептурной процедуры](article-images/recipe_procedure.svg)

#### Аппаратная процедура (*unit procedure*)

Схема аппаратной процедуры для приготовления творожной массы:

![Изображение аппаратной процедуры](article-images/unit_procedure.svg)

Схема операционной процедуры для операции **"Отделение сыворотки"**:

![Изображение операционной процедуры для **Отделение сыворотки**](article-images/whey_separation_operation_procedure.svg)

Схема операционной процедуры для операции **"Откачка сыворотки"**:

![Изображение операционной процедуры для **Откачка сыворотки**](article-images/whey_pumpdown_operation_procedure.svg)
