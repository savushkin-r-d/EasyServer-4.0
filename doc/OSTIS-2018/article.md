...
## Введение
Целью работы является развитие онтологической модели предприятия рецептурного производства для описания большего количества этапов производства, в том числе и не происходящих непосредственно на предприятии, учитывающее результаты, полученные в рамках инициативы Industry 4.0.
