...
## 2. Описание предприятия и его производственных процессов
...
### 2.1 Описание логистических процессов производства творога “Хуторок”

Упрощенная логистическая цепочка для творога “Хуторок” включает следующие этапы:
...
### 2.2 Описание технологии производства творога

Технология производства творога может быть описана по стандарту S88. В контексте автоматизированного производства и данного стандарта, выделяются следующие специализированные внешние языки - язык описания процедурной модели (PFC) и язык описания физической модели (P&ID). С помощью языка PFC будет описан фрагмент производственной ячейки по изготовлению творога “Хуторок”, который будет рассмотрен далее.
...
### 2.3 Описание требуемых робототехнических комплексов
...
Разработка методов и алгоритмов интеллектуального управления промышленным роботом позволяет решить проблему излишней специализации программного обеспечения за счет возможности переобучения робота, использования накопленных знаний в решении типовых задач.
...
## 2. Реализация модели предприятия и его процессов с помощью семантических технологий

Предлагаемая система разрабатывается на основе Технологии OSTIS, также в рамках структурного подхода было решено начать разработку с построения модели технологического процесса изготовления творога "Хуторок" по стандарту S88. Было разделена модель описания (язык описания) и реализация (система).

### 2.1 Модель языков описания предприятия и его процессов
...
### 2.2 Модель языков описания ячейки производства творога “Хуторок”
...
### 2.3 Модель ячейки производства творога “Хуторок”
...
Семантика аппаратной процедуры, записанная на языке SCg:
...
### 2.4 Модель взаимодействия роботехнических комплексов

Данная модель находится в разработке.
