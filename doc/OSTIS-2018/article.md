...
//Рассказать о подходе к построению гибких интерфейсов (онтология семантики, онтология синтаксиса, онтология правил перехода)

//ниже по примеру на каждую из онтологий с пояснением того, как это должно работать
...
Далее будет представлена запись аппаратной процедуры на языке процедурной модели PFC и на языке семантических сетей (SCg).
