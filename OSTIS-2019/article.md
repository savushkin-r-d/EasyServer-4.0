...
Они выполняют свои классические функции (более или менее успешно в текущей их реализации). На уровне SCADA-системы решается задача диспетчерского управления технологическим процессом (оператором), сбора и архивации технологических данных. На следующем уровне - MES (управление производственными процессами) - осуществляется выпуск продукции в рамках производства. Готовая продукция до отгрузки заказчику хранится на складе (WMS). Уровень ERP (планирование ресурсов предприятия) определяет, какой продукт в каких количествах и на каких производственных мощностях будет производится. Каждый уровень связан не только с последующим, но и с предыдущим.
